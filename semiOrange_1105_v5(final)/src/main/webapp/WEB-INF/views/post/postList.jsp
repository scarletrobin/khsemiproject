...
<body>
	...
	<div class="mypagemain container row">
		...
		<div class="mypage-content content column">
			...
			<!-- 
			<h4><span class="transactionop">받은 쪽지함</span> / <span class="transactionop">보낸쪽지함</span></h4>			
			 -->
			<h4><a href="/postList?reqPage=1" style="text-decoration:none; color:black">받은 쪽지함</a> / <a href="/myPostList?reqPage=1" style="text-decoration:none; color:rgb(158, 158, 158)">보낸쪽지함</a></h4>
			<!-- 받은쪽지함 -->
			<div class="transactiontbl">
				<h5>총 ${totalCount }개</h5>
				<div class="delbutton">
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<h5><a href="/postView?postNo=${p.postNo }" class="posttitle">${p.postTitle }</a></h5>
...
$(".delete").click(function(){
	...
	location.href="/myPageDeletePost?postNo="+postNum.join("/");
});
