			...
			<fieldset>
				...
				<table class="table" style="width:100;">
					<tr class="table-active">
						<th>제목</th>
						<td colspan="3">
							<input type="text" name="qnaTitle" class="form-control" value="${q.qnaTitle }">
						</td>
					</tr>
					<tr class="table-active">
						<th>작성자</th>
						...
						<td style="text-align: left;">
							...
							<c:choose>
								...
								<span class="delFile">${q.fileName }</span>
								<button type="button" id="delBtn" class="btn btn-primary btn-sm delFile">삭제</button>
								<input type="file" name="upfile" style="display:none;">
								<input type="hidden" name="oldFilename" value="${q.fileName }">
								<input type="hidden" name="oldFilepath" value="${q.filePath }">									
								</c:when>
								<c:otherwise>
					...
					<tr class="table-active">
						...
						<td colspan="3" style="textalign:left;">
							<textarea id="qnaContent" name="qnaContent" class="form-control">${q.qnaContent }</textarea>
						</td>
					</tr>
					<tr class="table-active">
						<th colspan="4">
							<button type="submit" class="btn btn-danger btn-block">Qna등록</button>
						</th>
					</tr>
				</table>
			</fieldset>
