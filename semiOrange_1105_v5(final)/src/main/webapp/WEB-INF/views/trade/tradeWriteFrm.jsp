...
<body>
	...
	<div class="container container2">
		...
		<form action="/tradeWrite" method="post" enctype="multipart/form-data"
			...
			<fieldset>
				...
				<div class="row mb-4">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="trade-write-title"
							name="tradeTitle" placeholder="글 제목을 입력해주세요."> <span
					...
					<div class="col-sm-5 price-wrap">
						<div>
							<input type="text" class="form-control" name="price"
								id="trade-write-price" placeholder="가격을 입력해주세요."> <span
				...
				<div class="row mb-3">
					<label for="trade-wirte-textarea" class="col-sm-2 col-form-label">상품 정보</label>
					<div class="col-sm-9">
						<textarea class="form-control" name="tradeContent"
							id="trade-wirte-textarea" rows="8" placeholder="상품 정보를 입력해주세요."></textarea>
					</div>
				</div>
	...
	<script type="text/javascript" src="/js/trade/tradeWrite.js"></script>
</body>
</html>